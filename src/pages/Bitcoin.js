...
export default function BitcoinMain() {
  ...
  return (
    ...
    <seccion className="infoCriptos">
      ...
      <p>No tiene intermediarios al realizar un cobro o pago. Puede contar con varias cuentas y tiene un funcionamiento ininterrumpido las 24 horas.</p>
      <p>Hay que tener en cuenta que la moneda y la clave asociada al código criptográfico deben ser verificadas para su ejecución. Ahí entran los mineros de bitcoin, personas del todo el mundo con equipos especializados para realizar cálculos matemáticos complejos y que aportan a mantener segura la red de bitcoin o blockchain.</p>
      ...
      <p>El primer paso en el mundo cripto es elegir tu billetera virtual o wallet. Puedes usar un monedero Bitcoin en tu vida cotidiana con tu dispositivo móvil o puedes tener un monedero solo para pagos online desde su ordenador. En cualquier caso, puedes escoger tu monedero en un minuto. Las más usuales son <span>Exodus o Trust Wallet</span> para smartphone o PC, <span>Trezor o Ledger</span> para billeteras físicas (tipo pendrive) o <a href="https://www.bitaddress.org/bitaddress.org-v3.3.0-SHA256-dec17c07685e1870960903d8f58090475b25af946fe95a734f88408cef4aa194.html" target="_blank" rel="noreferrer">bitaddress.org</a> que te genera una dirección bitcoin en segundos sin nada más.</p>
      <p>Lo siguiente es obtener bitcoins. Puedes obtenerlos aceptándolos como pago por bienes y servicios o comprándoselos a un amigo o alguien cercano. También puedes comprarlos directamente desde una casa de cambio (exchange) con su cuenta bancaria.</p>
