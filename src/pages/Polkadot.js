...
export default function PolkadotMain() {
  ...
  return (
    ...
    <seccion className="infoCriptos">
      ...
      <p>Es gracias al trabajo de Wood, que Ethereum cuenta con el poderoso lenguaje de programación <span>Solidity</span>, el cual fue creado por su persona. Sin embargo, el 11 de enero 2016, Wood decidió que era momento de partir y comenzar su propio proyecto, abandonado el proyecto Ethereum.</p>
    ...
    <a href="#DOT"><img src={Arrow} alt="flecha arriba" width="45" style={{"padding": ".5rem", "margin-bottom": "-2.5rem"}}/></a>
    </div>
    </div>
    <Footer/>
    </div>
